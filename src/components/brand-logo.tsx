...
function BrandSymbol({ animated = false }: { animated?: boolean }) {
  return (
    ...
    >
      <defs>
        <linearGradient id="brand-shell" x1="16" x2="82" y1="14" y2="82">
        ...
        <linearGradient id="brand-stroke" x1="20" x2="75" y1="20" y2="78">
      ...
      <rect
        ...
        y="16"
      />
      <rect fill="url(#brand-shell)" height="52" rx="15" width="52" x="22" y="22" />
      <path
